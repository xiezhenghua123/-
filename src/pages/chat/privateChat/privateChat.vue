  ...
  <view class="chatInterface">
      ...
      <view v-for="(message, index) in messages" :key="message.messageId">
        ...
        >
          ...
          <view class="content">
            ...
            <b
              class="send-fail iconfont icon-gantanhao error"
            ...
            >
              <image
                ...
                mode="aspectFit"
              ></image>
              <view class="video-play-icon iconfont icon-yunhang size24"></view>
            </view>
            <view
            ...
            >
              ...
              <i class="iconfont icon-wj-wjj size22"></i>
            </view>
            <GoEasyAudioPlayer
    ...
    <view class="action-box" v-if="!video.visible">
      <view class="action-top">
        <view
          class="record-icon iconfont size22"
          :class="[audio.visible ? 'icon-yuyin' : 'icon-jianpan']"
        ...
        <view
          class="file-icon ml-10 iconfont icon-Emoji size25"
          @click="showEmoji"
        ></view>
        <view
          class="file-icon iconfont icon-more size22"
          @click="showMore"
        ></view>
      ...
      <view class="action-bottom" v-if="more.show">
        <view class="more-item" @click="sendImage">
          ...
          <view class="iconfont icon-tupian size24"></view>
          <text>图片</text>
        </view>
        <view class="more-item" @click="sendVideo">
          <!-- <image src="../../../static/images/shipin.png"></image> -->
          <view class="iconfont icon-shipin size24"></view>
          <text>视频</text>
        </view>
        <view class="more-item" @click="sendFile">
          <!-- <image src="../../../static/images/shipin.png"></image> -->
          <view class="iconfont icon-wj-wjj size24"></view>
          <text>文件</text>
        </view>
  ...
  methods: {
    ...
    sendFile() {
      ...
      wx.chooseMessageFile({
        count: 1,
        success(res) {
          let FileMessage = that.goEasy.im.createFileMessage({
            file: res,
            to: {
              id: that.friend.uuid,
