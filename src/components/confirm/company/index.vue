<template>
	<view>
		<u-modal :show="show" title="企业认证" showCancelButton @cancel="companyCancel" @confirm="companyConfirm">
			<view class="flex-dir form-data">
				<u-form labelWidth="auto" labelPosition="top" :model="companyData" :rules="companyFormRules"
					ref="company">
					<u-form-item label="姓名" prop="name" borderBottom required>
						<u--input v-model="companyData.name" border="none"></u--input>
					</u-form-item>
					<u-form-item label="社会信用代码" prop="number" borderBottom required>
					...
					<u-form-item label="法定代表人" prop="legalPerson" borderBottom required>
						<u--input v-model="companyData.legalPerson" border="none"></u--input>
					</u-form-item>
				</u-form>
			</view>
		</u-modal>
