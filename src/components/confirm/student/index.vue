<template>
	<view>
		<u-modal :show="show" title="学生认证" showCancelButton @cancel="studentCancel" @confirm="studentConfirm">
			<view class="flex-dir form-data">
				<u-form labelPosition="top" :model="studentData" :rules="studentFormRules" ref="student">
